 ...
 * @since 1.0
 */
public class StriderBannerFeature extends FeatureRenderer<StriderEntity, StriderEntityModel<StriderEntity>> {
	...
	public StriderBannerFeature(FeatureRendererContext<StriderEntity, StriderEntityModel<StriderEntity>> context) {
		super(context);
	}
