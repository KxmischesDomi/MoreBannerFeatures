...
public class BeeBannerFeatureRenderer extends FeatureRenderer<BeeEntity, BeeEntityModel<BeeEntity>> {
	...
	public BeeBannerFeatureRenderer(FeatureRendererContext<BeeEntity, BeeEntityModel<BeeEntity>> context) {
		super(context);
	}
